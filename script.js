...
document.querySelector(".tombol").addEventListener('click', function () {
  Swal.fire("Hallo Fiaku Tayang", "Aku ada pertanyaan nih buat kamu By", "question").then(function () {
    Swal.fire("Jawab yang jujur ya Tayang!").then(function () {
                ...
                Swal.fire({
                  ...
                  Swal.fire(`Makasih ya udah sayang sama ${sender} ${val}%`).then(function () {
                    Swal.fire({
                      ...
                      /* Read more about isConfirmed, isDenied below */
                      if (result.isConfirmed) {
                        Swal.fire(`Huhu iya ${sender} juga kangen ${nama} , makasihhh yaa Tayang`).then(function () {
